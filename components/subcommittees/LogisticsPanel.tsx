              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <datalist id="equipment-categories">
                    <option value="Najazd progowy kablowy 2 kanały (1)" />
                    <option value="Najazd progowy kablowy 2 kanały (2)" />
                    <option value="Najazd progowy kablowy 2 kanały (3)" />
                    <option value="Drabina" />
                    <option value="Konsola mikserska (1)" />
                    <option value="Konsola mikserska (2) + zasilacz" />
                    <option value="Konsoler DJ-ski" />
                    <option value="Głośnik (1)" />
                    <option value="Konsola mikserska (3)" />
                    <option value="Kolumna odsłuchowa (1)" />
                    <option value="Kolumna odsłuchowa (2)" />
                    <option value="Mikrofon przewodowy Shure PG58" />
                    <option value="Kolumna RCF (1)" />
                    <option value="Kolumna RCF (2)" />
                    <option value="Kolumna RCF (3)" />
                    <option value="Kolumna RCF (4)" />
                    <option value="Kolumna JBL (1)" />
                    <option value="Kolumna JBL (2)" />
                    <option value="Zestaw mikrofonów bezprzewodowych" />
                    <option value="Mikrofon przewodowy Shure PG48" />
                    <option value="Megafon VONYX" />
                    <option value="Mikrofon IMG przewodowy" />
                    <option value="Statyw kolumnowy 35mm (1)" />
                    <option value="Statyw kolumnowy 35mm (2)" />
                    <option value="Statyw kolumnowy 25mm" />
                    <option value="Mikrofon bezprzewodowy (1)" />
                    <option value="Mikrofon bezprzewodowy (2)" />
                    <option value="Statyw do mikrofonu (1)" />
                    <option value="Statyw do mikrofonu (2)" />
                    <option value="Statyw do mikrofonu (3)" />
                    <option value="Statyw na gitarę (1)" />
                    <option value="Statyw na gitarę (2)" />
                    <option value="Ibiza kolumna zestaw" />
                    <option value="Ibiza kolumna (1)" />
                    <option value="Ibiza kolumna (2)" />
                    <option value="Kolumna RH Sounds (1)" />
                    <option value="Kolumna RH Sounds (2)" />
                    <option value="Przedłużacz 5 m, gniazd Ever (1)" />
                    <option value="Przedłużacz 5 m, gniazd Ever (2)" />
                    <option value="Przedłużacz 5 m, gniazd Ever (3)" />
                    <option value="Przedłużacz 5 m, gniazd Ever (4)" />
                    <option value="Przedłużacz 5 m, gniazd Ever (5)" />
                    <option value="Przedłużacz 5 m, gniazd Ever (6)" />
                    <option value="Przedłużacz 5 m, gniazd Ever (7)" />
                    <option value="Przedłużacz 6 gniazd + 2 USB 1,5m" />
                    <option value="Przedłużacz 5 gniazd tracer 1,5 m" />
                    <option value="Przedłużacz 3 gniazda 1,5 m" />
                    <option value="Przedłużacz 5 gniazd 3m" />
                    <option value="Przedłużacz biurkowy 3 gniazda, 2 USB, 2m" />
                    <option value="Przedłużacz 4 gniazda, 10m" />
                    <option value="Przedłużacz 3 gniazda, 20 m" />
                    <option value="Przedłużacz bębnowy 4 gniazda 25m (1)" />
                    <option value="Przedłużacz bębnowy 4 gniazda 25m (2)" />
                    <option value="Reflektor Compact PAR" />
                    <option value="Cameo Light SUPERFLY HP" />
                    <option value="Panel ledowy RGB" />
                    <option value="Listwa UV 9 diod LED (1)" />
                    <option value="Listwa UV 9 diod LED (2)" />
                    <option value="Licznik czasu" />
                    <option value="Ledbar (1)" />
                    <option value="Ledbar (2)" />
                    <option value="Sterownik LED" />
                    <option value="Reflektor LED PAR" />
                    <option value="Ruchomy reflektor LED" />
                    <option value="Kratownica oświetleniowa (zestaw 2 szt.)" />
                    <option value="Ekran rozkładany (1)" />
                    <option value="Ekran rozkładany (2)" />
                    <option value="Aparat z obiektywem" />
                    <option value="Statyw fotograficzny (1)" />
                    <option value="Statyw fotograficzny (2)" />
                    <option value="Statyw fotograficzny (3)" />
                    <option value="Parasol do zdjęć (zestaw 2 szt.)" />
                    <option value="Stabilizator do kamery (1)" />
                    <option value="Projektor Optoma" />
                    <option value="Apteczka Główna (1)" />
                    <option value="Apteczka Główna (2)" />
                    <option value="Apteczka Główna (3)" />
                    <option value="Apteczka Zapasowa" />
                  </datalist>
                </div>
              </div>
              <div>
